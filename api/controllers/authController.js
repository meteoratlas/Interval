...
exports.protect = catchAsync(async (req, res, next) => {
    ...
    if (!currentUser) {
        return next(
            new AppError(
                "The user who requested this token no longer exists.",
                401
            )
        );
    }
...
exports.restrictTo = (...roles) => {
    return (req, res, next) => {
        // we have access to req.user because the previous middleware (protect) always runs before this one
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
    ...
    try {
        ...
        return next(
            new AppError(
                "There was an issue sending the passord reset email.",
                500
            )
        );
    }
